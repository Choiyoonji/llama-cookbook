...
class train_config:
    ...
    output_dir: str = "./PEFT/model_force_0410"
    ...
    dist_checkpoint_root_folder: str="./FSDP/model" # will be used if using FSDP
    ...
    profiler_dir: str = "./profiler/results" # will be used if using profiler
